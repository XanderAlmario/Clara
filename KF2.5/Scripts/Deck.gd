...
var paladin_deck = ["Aspirant Squire", "Aspirant Squire", "Blessed Parishioner", "Blessed Parishioner",
"Holy Strike", "Holy Strike", "Fatigue Aura", "Fatigue Aura",
"Banner Bearer", "Banner Bearer", "Crusader's Might", "Crusader's Might",
"Blessed Crusader Hound", "Blessed Crusader Hound", "Bottle of Devotion", "Bottle of Devotion",
"Uther Pureheart", "Holy Crusader", "Holy Crusader", "Artimose Aetherion",
"Summon the Infantry", "Summon the Infantry", "Bring in the Holy Crusade","Thaloran Lightguard"]
var monk_deck = ["Training Student", "Training Student", "Aggressive Youngin", "Aggressive Youngin",
"Cup of Chai", "Cup of Chai",
"Double Trouble", "Double Trouble", "Bulwark Brother", "Bulwark Brother",
"Training Mentor", "Training Mentor",
"Shadow Arts", "Shadow Arts", "Way of Drinking Master", "Swiftfist Monk", "Kensei Monk", "Kensei Monk",
"Dragon's Kick", "Dragon's Kick", "Way of Mercy Master", "Way of Astral Master",
"Way of Open Hand Master"]
var player_deck = ["Thaloran Lightguard", "Way of Mercy Master", "Way of Mercy Master", "Way of Mercy Master",
"Way of Mercy Master", "Defender Aura", "Fatigue Aura", "Defender Aura",
"Fatigue Aura", "Defender Aura", "Fatigue Aura", "Banner Bearer"]
var cardDBRef
var drewCard = false
var deck_timer
...
func drawCard(drawnCardName):
	...
	newCard.cardName = drawnCardName
