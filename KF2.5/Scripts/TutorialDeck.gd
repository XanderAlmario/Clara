...
var player_deck = ["Aspirant Squire", "Blessed Parishioner", "Thaloran Lightguard", 
"Defender Aura", "Summon the Infantry", 
"Artimose Aetheron", "Defender Aura", "Holy Crusader", 
