...
func before_each():
	panel = load("res://Scenes/Tutorial.tscn").instantiate()
	add_child(panel)

func _advance(times: int):
	for _i in range(times):
		panel.instructionShow()
...
func test_first_visible_on_ready():
	assert_true(panel.get_node("First").visible,  "First should be visible on ready")
 
func test_second_hidden_on_ready():
	assert_false(panel.get_node("Second").visible, "Second should be hidden on ready")
...
func test_step2_shows_second():
	_advance(1)
	assert_true(panel.get_node("Second").visible, "Second should be visible at step 2")
 
func test_step2_hides_first():
	_advance(1)
	assert_false(panel.get_node("First").visible, "First should be hidden at step 2")
...
func test_step3_shows_third():
	_advance(2)
	assert_true(panel.get_node("Third").visible)
 
func test_step3_hides_second():
	_advance(2)
	assert_false(panel.get_node("Second").visible)
...
func test_step4_shows_fourth():
	_advance(3)
	assert_true(panel.get_node("Fourth").visible)
 
func test_step4_hides_third():
	_advance(3)
	assert_false(panel.get_node("Third").visible)
...
func test_step5_shows_fifth():
	_advance(4)
	assert_true(panel.get_node("Fifth").visible)
 
func test_step5_hides_fourth():
	_advance(4)
	assert_false(panel.get_node("Fourth").visible)
...
func test_step6_shows_sixth():
	_advance(5)
	assert_true(panel.get_node("Sixth").visible)
 
func test_step6_hides_fifth():
	_advance(5)
	assert_false(panel.get_node("Fifth").visible)
...
func test_step7_shows_seventh():
	_advance(6)
	assert_true(panel.get_node("Seventh").visible)
 
func test_step7_hides_sixth():
	_advance(6)
	assert_false(panel.get_node("Sixth").visible)
...
func test_step8_shows_eighth():
	_advance(7)
	assert_true(panel.get_node("Eighth").visible)
 
func test_step8_hides_seventh():
	_advance(7)
	assert_false(panel.get_node("Seventh").visible)
