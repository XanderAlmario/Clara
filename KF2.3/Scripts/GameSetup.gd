...
func host_setup():
	...
	get_parent().get_node("EnemyField/Username").text = get_parent().get_node("Opponent").username
...
func client_setup():
	...
	get_parent().get_node("PlayerField/Username").text = get_parent().get_node("Opponent").username
	get_parent().get_node("EnemyField/Username").text = get_parent().get_node("Player").username
