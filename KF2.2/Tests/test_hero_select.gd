...
func test_on_monk_select_pressed_logic():
	...
	assert_eq("Monk", player.champion, "player class should be set to monk")
	
func test_on_paladin_select_pressed_logic():
	_menu._on_paladin_select_pressed()
	assert_eq("Pal", player.champion, "player class should be set to paladin")
	
func test_on_undead_select_pressed_logic():
	_menu._on_undead_select_pressed()
	assert_eq("Nec", player.champion, "player class should be set to undead")
	
func test_on_archer_select_pressed_logic():
	_menu._on_archer_select_pressed()
	assert_eq("Arch", player.champion, "player class should be set to archer")
